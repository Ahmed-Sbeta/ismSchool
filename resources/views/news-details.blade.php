                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="blog-details-desc">
                            <div class="article-image">
                                <img src="{{asset(Storage::url($news->image))}}" alt="image" style="border-radius:5px;">
                            </div>
                            ...
                            <div class="article-content">
                                ...
                                <h3>{{$news->title}}</h3>
                                <p class="mb-4 text-sm" style="font-size: 12px; height:150px; overflow: hidden; overflow-wrap: break-word;">{{$news->text}}</p>
